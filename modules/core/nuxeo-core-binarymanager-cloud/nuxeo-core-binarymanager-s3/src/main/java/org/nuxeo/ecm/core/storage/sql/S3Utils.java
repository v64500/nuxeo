...
public class S3Utils {
    ...
    public static ObjectMetadata copyFileMultipart(AmazonS3 amazonS3, ObjectMetadata objectMetadata,
        ...
        long partSize = configurationService == null ? MULTIPART_COPY_PART_SIZE_DEFAULT
                : configurationService.getLong(MULTIPART_COPY_PART_SIZE_PROPERTY, MULTIPART_COPY_PART_SIZE_DEFAULT);
